...
### GitBucket
*GitBucke*t* — это клон **GitHub**, написанный на `Scala`. У него не так много функций, как у других приложений в списке. На самом деле его главное преимущество — это сходство с `GitHub`. Другими словами, если вы начинаете скучать по `GitHub`, вы всегда можете прибегнуть к *GitBucket*.
